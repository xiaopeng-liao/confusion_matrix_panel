...
export class ConfusionMatrixCtrl extends MetricsPanelCtrl {
  ...
  onInitEditMode() {
    this.addEditorTab('Options', 'public/plugins/confusion-matrix-panel/editor.html', 2);
...
ConfusionMatrixCtrl.templateUrl = 'module.html';
